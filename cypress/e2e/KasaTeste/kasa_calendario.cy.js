    ...
    it ("Adicionar Partida ao Calendario ", () => {
        ...
        it ("Buscar Partida No Calendario por Time ", () => {
           //Abre o Site e Realiza a Busca de time com proximo jogo
            ...
            cy.get('input[placeholder*="Pesquisar"]').first().type(time_com_jogo)
            cy.wait(1000)
        ...
        it ("Buscar Partida No Calendario por Campeonato ", () => {
            //Abre o Site e Realiza a Busca de Campeonato com proximo jogo
            cy.visit(baseUrl)
            cy.wait(5000)
            cy.get('#filter-championship').click().type(campeonato_com_jogo)
            cy.wait(500)
            ...
            cy.get('input[placeholder*="Pesquisar"]').eq(1).type(campeonato_com_jogo)
            cy.wait(1000)
